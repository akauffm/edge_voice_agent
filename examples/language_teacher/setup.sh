...
# DE
wget https://huggingface.co/rhasspy/piper-voices/blob/main/de/de_DE/thorsten/low/de_DE-karlsson-low.onnx
wget https://huggingface.co/rhasspy/piper-voices/blob/main/de/de_DE/thorsten/low/de_DE-karlsson-low.onnx.json
